...
public class AlertPkTask implements Runnable {
    ...
    public void WarningPK(Player player,int timeLeft) {
        ...
        Objective objective = board.registerNewObjective("mcpk", Criteria.PLAYER_KILL_COUNT,"dummy");
        objective.setDisplaySlot(DisplaySlot.SIDEBAR);
        objective.setDisplayName(plugin.translate.TimeLeftOnPK);

        Score score = objective.getScore(Objects.requireNonNull(Bukkit.getOfflinePlayer(player.getUniqueId()).getPlayer()).getName());
